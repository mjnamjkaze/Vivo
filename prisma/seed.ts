...
async function main() {
    ...
    // =================================================================================================
    // 100 CÂU HỎI TOÁN LỚP 1 KÌ 2 (Cộng trừ trong phạm vi 100, Hình học, Đo lường, Thời gian)
    // =================================================================================================
    const mathQuestions = [
    ...
    // =================================================================================================
    // 100 CÂU HỎI TIẾNG VIỆT LỚP 1 KÌ 2 (Chính tả, Từ vựng, Đọc hiểu, Câu)
    // =================================================================================================
    const vietQuestions = [
        ...
        { q: "Cây gì có quả màu đỏ, ăn chua?", a: "Cây bàng", b: "Cây khế", c: "Cây chanh", d: "Cây ớt", correct: "C" }, // Chanh chua, nhưng ớt cay. Khế chua nhưng màu xanh/vàng. Cà chua? Câu này hơi ambiguous. Let's fix.
        ...
        { q: "Câu nào đúng?", a: "Con mèo chèo cây cau.", b: "Con mèo trèo cây cau.", c: "Con mèo chèo cây cao.", d: "Con mèo trèo cây cao.", correct: "B" }, // Trèo cây cau is the rhyme
        ...
        { q: "Trong bài thơ 'Mèo con đi học', mèo con quên cái gì?", a: "Bút chì", b: "Cái mũ", c: "Ăn sáng", d: "Quyển vở", correct: "C" }, // Mèo con đi học chẳng mang thứ gì, chỉ mang một cái bút chì, và mang một mẩu bánh mì con con. Wait, this is a song. Let's use generic knowledge.
        ...
        { q: "Chữ cái cuối cùng trong bảng chữ cái là?", a: "X", b: "Y", c: "V", d: "Y", correct: "B" }, // Y dài is last in VN alphabet usually taught? Or X? Actually it's Y.
        { q: "Bác Hồ tên thật là gì?", a: "Nguyễn Sinh Cung", b: "Nguyễn Tất Thành", c: "Nguyễn Ái Quốc", d: "Hồ Chí Minh", correct: "A" }, // Grade 1 might know Ho Chi Minh.
    ...
    // =================================================================================================
    // 100 CÂU HỎI TIẾNG ANH LỚP 1 KÌ 2 (Vocab, Colors, Numbers, Family, Animals)
    // =================================================================================================
    const engQuestions = [
        // Numbers (1-20)
